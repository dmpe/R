...
Namely, what was the relationship between size of debaters and academicians over the years?
Did it mean that if you participitated as an academician in the conversations debate size was also increasing? Let's find it out :) First, however, prepare the dataset.
...
So, the mean debate size will grow by `r lm_aca_deb$coefficients[2]` as the number of academicians increases by 1. If there are zero academicians, the debate size predicts to be `r lm_aca_deb$coefficients[1]`.

[Source for LM](https://onlinecourses.science.psu.edu/stat501/node/252)
...
Clearly, academicians prevail in majority of debates as the number of outsiders declined significantly over last few years. Also, the number of participitants in debates does not grow much. 
